...
export const STRAPCO_S_LOGO = (
  <div className="flex items-center gap-6 group">
    <div className="relative flex items-center justify-center h-14 w-14 border border-white/10 rounded-sm overflow-hidden bg-navy-900 group-hover:border-brand/50 transition-all duration-500">
      <svg viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-8 h-8 transform transition-transform group-hover:scale-110 duration-500">
        <path 
    ...
    <span className="text-3xl font-black tracking-[-0.05em] text-white uppercase group-hover:text-brand transition-all duration-500">
...
export const STRAPCO_FULL_LOGO = (
  <div className="flex flex-col">
    <div className="flex items-center gap-8">
      <div className="relative h-20 w-20 border border-white/10 bg-navy-900 flex items-center justify-center rounded-sm">
      ...
      <span className="text-6xl font-black tracking-[-0.05em] text-white uppercase">
        STRAPCO<span className="text-brand">.</span>
      </span>
    </div>
    <div className="mt-8 flex items-center gap-6">
      <div className="h-px w-10 bg-brand"></div>
      <span className="text-[11px] font-black tracking-[0.7em] text-slate-500 uppercase">
        Strategic Delivery
      </span>
    </div>
  </div>
