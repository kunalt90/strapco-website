...
export const SERVICES: ServiceDetail[] = [
  {
    ...
    category: "Discovery",
    description:
      "Advanced behavioral research and prototyping for the UK public sector. We define high-integrity user logic before any code is written.",
  ...
  },
  {
    ...
    description:
      "Elite technical delivery squads specializing in legacy modernization and cloud infrastructure for regulated estates.",
  ...
  },
  {
    ...
    category: "Strategy",
    description:
      "High-level consultancy for board-level stakeholders. Navigating the intersection of policy, legacy tech, and future goals.",
