...
const init = () => {
  ...
  try {
    ...
    container.innerHTML = `<div style="color: white; padding: 40px; font-family: Inter, system-ui, sans-serif; height: 100vh; background: #02040a;">
      ...
      <pre style="background: #0a0c12; padding: 20px; border: 1px solid #11141d; color: #94A3B8; font-size: 12px; overflow: auto;">${
